...
import styles from "../styles/BusinessDirectorsStyles";
            ...
            <View style={styles.inner}>
                <View style={[styles.frameParent, styles.groupChildPosition1]}>
                    <View style={styles.frameGroup}>
                        <View style={styles.frameGroup}>
                            <View style={styles.frameGroup}>
                                {/* Title text for Business Directors */}
                                <Text style={styles.label1}>Business Directors</Text>

                                {/* Informational text */}
                                <Text
                                    style={[styles.dueToRegulatory, styles.innerPosition, { width: 510 }]}
                                >
                                    {`Due to regulations, we're required to collect information
about a company's directors. Please be sure to enter this
information correctly, as we may verify this information
with that in the Companies Registration Office (CRO) and
may need to report discrepancies to them. Learn more`}
                                </Text>
                                ...
                                >
                                    {`Please list all individuals who are members of the governing
board of the company`}
                                </Text>

                                {/* Button to add a director */}
                                <View style={[styles.button1, styles.button1FlexBox]}>
                                    <Image
                                        style={[styles.vectorIcon, styles.iconLayout]}
                                        contentFit="cover"
                                        source={require("../assets/vector.png")} // Add director icon
                                    />
                                ...
                                {/* Button to continue without adding a director */}
                                <Pressable
                                    style={[styles.continueWithNoOwnersParent, styles.button2FlexBox]}
                                    onPress={() => {
                                        navigation.navigate("Bank Details"); // Navigate to Bank Details screen
                                    }}
                                >
                                    <Text style={[styles.continueWithNo, styles.numberTypo]}>
                                        Continue with no director
                                    </Text>
                                    <Image
