...
const ConnectionsEstablished = ({ timeframe }) => {
    return (
            ...
            <View style={styles.chartWrapper}>
                <ResponsiveContainer width={402} height={130}>
                    <AreaChart data={data[timeframe]}>
                        ...
                        <Area type="monotone" dataKey="uv" stroke="#F94144" strokeWidth={3} fill="rgba(248, 113, 116, .25)" />
                        <Area type="monotone" dataKey="pv" stroke="#F87174" strokeWidth={3} fill="rgba(248, 113, 116, .25)" />
...
export default ConnectionsEstablished;
